...
const INPUT_CLASS =
  'w-full px-4 py-3 border border-slate-200 rounded-xl text-sm bg-slate-50 text-slate-900 placeholder-slate-400 outline-none transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-slate-300';
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex gap-3">
                <Link
                  to="/login"
                  className="flex-1 py-3 text-center bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold text-sm transition-all focus:outline-none focus:ring-2 focus:ring-slate-300"
                >
                  Cancel
                </Link>
                <button
